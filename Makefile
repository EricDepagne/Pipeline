...
help:
	...
	@echo
	@echo "  install             -- to install package in virtual environment"
	@echo "  install-dev         -- to install package in virtual environment with everything for development"
...
clean: delpyc
	rm -Rf venv dist .tox pipeline.egg-info .cache tests/__pycache__/
